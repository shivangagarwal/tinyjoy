...
export const metadata: Metadata = {
  ...
  description:
    'Play 23 free online games instantly in your browser. No download, no sign-up. Word games, puzzles, arcade games, and more — all free.',
  ...
  openGraph: {
    ...
    description:
      'Play 23 free online games instantly. No download, no sign-up. Word games, puzzles, arcade and more.',
    url: `${BASE_URL}/games`,
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Free Online Games — Play Instantly, No Download | TinyJoy',
    description: 'Play 23 free online games instantly. No download, no sign-up.',
